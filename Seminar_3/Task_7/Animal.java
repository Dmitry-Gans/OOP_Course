...
// Можете объяснить как из этого
// animals.sort((animal1, animal2) -> animal1.getAge() - animal2.getAge());
// получили
// animals.sort(Comparator.comparingInt(Animal::getAge)); // В аргумент передается  только метод или ссылка на метод